<header>
	<h1 class="h4" style="margin-top: 2em;">
		<a href="https://facebook.com/{$benefit->eventfbid}" onClick="_gaq.push(['_trackEvent', 'external', 'header_link_click', '{$benefit->eventfbid}']);" rel="external" title="{$benefit->name}">
